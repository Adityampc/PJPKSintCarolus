						...
						<form method="post" action="<?= current_url() ?>">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input required autocomplete="off" type="text" class="form-control" id="title" name="title" placeholder="Enter title">
								</div>
								<!-- Date and time -->
								<div class="form-group">
									<label>Date</label>
									<div class="input-group date" id="reservationdatetime" data-target-input="nearest">
										<input autocomplete="off" required type="text" name="dateto" id="dateto" class="form-control datetimepicker-input" data-target="#reservationdatetime" />
								...
								<div class="form-group">
									...
									<textarea autocomplete="off" name="description" class="form-control" id="description" name="description" cols="30" rows="10"></textarea>
								</div>
							</div>
